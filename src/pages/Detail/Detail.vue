        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(title, index) in spuSaleAttrList" :key="title.id">
                <dt class="title">{{ title.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  v-for="(choose, index) in title.spuSaleAttrValueList"
                  :key="choose.id"
                  :class="{ active: choose.isChecked == 1 }"
                  @click="changeActive(choose, title.spuSaleAttrValueList)"
                >
                  {{ choose.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
